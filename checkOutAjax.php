...
$sql = "SELECT * FROM cart WHERE USER_EMAIL = '$email';";
    ...
    {        
        $sqlDelete = "DELETE FROM cart WHERE USER_EMAIL = '$email'";
        if (mysqli_query($conn, $sqlDelete)) {
            
        } else {
            echo "Error Buying " . mysqli_error($conn);
        }
    ...
    else
    {
        echo "Cart is Empty";
            ...
            if ($resultItemsBought) {
                ...
                $newItemsBought = $currentItemsBought + $totalitems;
...
<div id="confirmationMessage">
  <p>Your products will arrive soon. Press "OK" to continue.</p>
</div>
