...
<head>
    ...
    <link rel="stylesheet" href="menClothes.css">
...
<body>
        ...
        <ul class="nav-menuu">
         ...
         <li class="nav-itemm">
          ...
          <form action="" class="search-form">
            <input type="search" id="search-box" placeholder="Search NIKE's MEN" 
  ...
  <a href="Pages/menClothes/menClothes/menClothes.php" style="text-decoration:none; color:black;">
    <img src="../../../Images/Products/Essential4.jpg" alt="Essential 1" style="width: 100%; height: 100%; object-fit: cover;">
    <h2>Clothing</h2>
  </a>
  </div>
  <div class="Essential2">
  <a href="Pages/womenClothes/womenClothes/womenClothes.php" style="text-decoration:none; color:black;">
    <img src="../../../Images/Products/Essential3.jpg" alt="Essential 2" style="width: 100%; height: 100%; object-fit: cover;">
 <h2>Shoes</h2> 
  </a>
  </div>
</div>
  ...
  <a href="../../singleProduct/singleProduct.php?id=46" style="text-decoration:none; color:black;">
    <img src="../../../Images/Products/JustIn1.jpg" alt="Essential 1" style="width: 100%; height: 100%; object-fit: cover;">
  ...
  <a href="../../singleProduct/singleProduct.php?id=47" style="text-decoration:none; color:black;">
    <img src="../../../Images/Products/JustIn3.jpg" alt="Essential 2" style="width: 100%; height: 100%; object-fit: cover;">
    <button class="shop_men_button" id="test">Shop&emsp;&#8594;</button>
  </a>
  </div>
  <div class="JustIn3" style="width: 400px; height: 450px; margin-bottom: 80px; flex-direction:row;">
  <a href="../../singleProduct/singleProduct.php?id=48" style="text-decoration:none; color:black;">
    <img src="../../../Images/Products/JustIn2.jpg" alt="Essential 1" style="width: 100%; height: 100%; object-fit: cover;">
    <button class="shop_men_button" id="test">Shop&emsp;&#8594;</button>
        ...
        <div id="photoSlider" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../../Images/Products/Jumpman1.jpg" class="d-block w-100" alt="Slide 1">
                </div>
                <div class="carousel-item">
                    <img src="../../../Images/Products/Jumpman2.jpg" class="d-block w-100" alt="Slide 2">
                </div>
                <div class="carousel-item">
                    <img src="../../../Images/Products/Jumpman3.jpg" class="d-block w-100" alt="Slide 3">
                </div>
            </div>
    ...
    $sql = "SELECT * FROM product WHERE TYPE = 'Clothing' AND SPORT = 'Football' AND GENDER = 'M';";
...
$conn->close();
    ...
    $conn = mysqli_connect($server, $user, $pass, $dbname,3307);
    $sql = "SELECT * FROM product WHERE TYPE = 'Clothing' AND SPORT = 'Tennis' AND GENDER = 'M';";
            $result = mysqli_query($conn, $sql);
...
$conn->close();
    ...
    $conn = mysqli_connect($server, $user, $pass, $dbname,3307);
    $sql = "SELECT * FROM product WHERE TYPE = 'Clothing' AND SPORT = 'Basketball' AND GENDER = 'M';";
            $result = mysqli_query($conn, $sql);
...
<!-- <div class="Card">
        <div class="Photo">
          <img src="../../../Images/Products/Essential3.jpg" alt="FOOTSHOE" style="display: flex; align-items: center; justify-content: center;">
        </div>
        <div class="Allcarditems"> 
          <div class="ProductDescription" style="margin: 0 15px;">
          <div>
          ...
          <div class="productprice">
          <s style="color: #f60;">100 L.E</s>
          <Span>200 L.E</Span>
      </div>
      </div>
      <div style="display: flex;justify-content: center;align-items: center;">
        <a href="../../singleProduct/singleProduct.php?id=34" style="text-decoration: none;">
    ...
    $conn = mysqli_connect($server, $user, $pass, $dbname,3307);
    $sql = "SELECT * FROM product WHERE TYPE = 'Shoes' AND SPORT = 'Football' AND GENDER = 'M';";
            $result = mysqli_query($conn, $sql);
...
$conn->close();
    ...
    $conn = mysqli_connect($server, $user, $pass, $dbname,3307);
    $sql = "SELECT * FROM product WHERE TYPE = 'Shoes' AND SPORT = 'Tennis' AND GENDER = 'M';";
            $result = mysqli_query($conn, $sql);
...
$conn->close();
    ...
    $conn = mysqli_connect($server, $user, $pass, $dbname,3307);
    $sql = "SELECT * FROM product WHERE TYPE = 'Shoes' AND SPORT = 'Basketball' AND GENDER = 'M';";
            $result = mysqli_query($conn, $sql);
...
<!-- <div class="Card">
        <div class="Photo">
          <img src="../../../Images/Products/OG MAKE IT LAST FRONTFACE.png" alt="OG MAKE IT LAST" style="display: flex; align-items: center; justify-content: center;">
        </div>
        <div class="Allcarditems"> 
          <div class="ProductDescription" style="margin: 0 15px;">
          <div>
            <h3>"OG MAKE IT LAST"</h3>
          </div>
          <div class="productprice">
          <s style="color: red;">450 L.E</s>
          <Span>350 L.E</Span>
      </div>
      </div>
      <div style="display: flex;justify-content: center;align-items: center;">
        <a href="../../singleProduct/singleProduct.php?id=27" style="text-decoration: none;">
          <button class="BuyNowButton" style="cursor: pointer;">Shop</button>
        </a>
      </div>
      </div>
